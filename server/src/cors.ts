 ...
 * @returns The {@link server.ServerEventHandler} that can be used to handle CORS functionality via server events.
...
export const createCORSHandler = (
  ...
  server.createCORSHandlerGeneric<ctx.ServerContext>(
